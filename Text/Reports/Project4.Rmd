---
title: "Project4"
author: "Charlie, Renjun Luo, Feng Wang, Flight Liu"
date: "2022/10/02"
output: pdf_document
---
...
for(i in 1:128)
{
  ...
  {
   if(j>i & j<256-i)
   {strips[i,j] = dgammaSAR(1, 5,  2)}
   else if(j<i)
   {strips[i,j] = dGI0(1, -3, 14,  2)}
   else if(j>256-i)
    {strips[i,j] = dgammaSAR(1, 50,  2)}
  }
...
ggplot(transects.3.flat, 
  ...
  geom_hline(yintercept = 2, linetype="longdash", col="cornsilk3") +
