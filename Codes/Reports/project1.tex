...
\IEEEPARstart{C}reating a simple and perspicuous repository for the scientific project is a quite essential ability when performing scientific researches. Therefore, we built our own git repository under the guidance of Prof. Frery~\cite{2020A}.
